<template>
  <header
    class="w-full fixed navbar-blur-dark text-white flex flex-row justify-around items-center h-14 z-10 shadow-md"
  >
    <a class="flex flex-row space-x-3 items-center" href="#home">
      <h2 class="text-base">Pavlos Defoort</h2>
      <svg
    ...
    <svg
      ...
      stroke-width="1.5"
      stroke="currentColor"
      class="size-6 hover:text-gray-300 cursor-pointer hover:scale-105 md:hidden"
      @click="toggleNav"
    >
      <path
    ...
    <transition name="fade-slide">
      <nav
        v-if="isNavVisible"
        class="absolute top-14 left-0 h-screen w-full bg-black text-white flex flex-row justify-start items-start py-4"
      >
        <ul class="flex flex-col space-y-4 items-start font-inter text-lg px-8">
          <li>
            <a href="#home" class="hover:text-gray-300" @click="toggleNav"
              >Home</a
            >
          </li>
          <li>
            <a href="#about" class="hover:text-gray-300" @click="toggleNav"
              >About</a
            >
          </li>
          <li>
            <a href="#projects" class="hover:text-gray-300" @click="toggleNav"
              >Projects</a
            >
          </li>
          <li>
            <a href="#contact" class="hover:text-gray-300" @click="toggleNav"
              >Contact</a
            >
          </li>
        </ul>
